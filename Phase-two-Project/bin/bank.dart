...
//   // SRP: Account only validates, it doesn't "ask" the user
...
//     while (true) {
//       print("\n--- 🏦 MINI BANK SYSTEM ---");
//       print("1. Create | 2. Deposit | 3. Withdraw | 4. Balance | 5. Transfer | 6. Exit");
//       stdout.write("Choice: ");
//       String choice = stdin.readLineSync() ?? "";

//       try {
//         switch (choice) {
//           case '1': _handleCreate(); break;
...
//     stdout.write("Initial Deposit: ");
//     double bal = double.tryParse(stdin.readLineSync()!) ?? 0;
//     stdout.write("Mobile Number: ");
//     String num = stdin.readLineSync()!;
//     stdout.write("Set 4-Digit PIN: ");
//     String pin = stdin.readLineSync()!;
    
//     _accounts.add(Account(name: name, balance: bal, number: num, pin: pin));
